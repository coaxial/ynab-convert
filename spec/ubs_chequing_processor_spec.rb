  ...
  context 'with a valid CSV file' do
    ...
    it 'outputs valid YNAB4 CSV data' do
      ...
      expected = <<~ROWS
        ...
        "06/11/2019","Recouvrement VIS1W OBJECTION TO UBS WITHIN 30 DAYS, UBS SWITZERLAND AG, C/O UBS CARD CENTER, CREDIT CARD STATEMENT, OF 15.11.2019, ACCOUNT NUMBER 0000 1234 5678 9012, LSV débit CHF","","10959.40",""
